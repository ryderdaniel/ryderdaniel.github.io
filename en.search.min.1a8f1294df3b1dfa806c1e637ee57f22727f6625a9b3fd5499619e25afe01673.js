...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.12bb7a9e06b4c2c9205879a947ec970bb8f085d9a9c44655b38814403658e753.js',function(){input.required=false;search();});}
