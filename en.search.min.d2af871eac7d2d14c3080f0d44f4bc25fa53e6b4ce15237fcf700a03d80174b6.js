...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.de32eaeb58010e09b09bbc901ef8e568433268cdefe9a359493c8b286649eae8.js',function(){input.required=false;search();});}
