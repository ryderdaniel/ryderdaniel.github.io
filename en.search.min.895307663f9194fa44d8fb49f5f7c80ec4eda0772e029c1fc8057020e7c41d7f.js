...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.371b6e31abcec0371f66f31b02420d73b7eb8f6552eb7dcaa67c093126e70c62.js',function(){input.required=false;search();});}
