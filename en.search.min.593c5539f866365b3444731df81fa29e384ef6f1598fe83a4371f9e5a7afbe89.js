...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ff4d6c3027363202009d3722d82eef52e1ae28dd9793a90132d19aae388a90cc.js',function(){input.required=false;search();});}
