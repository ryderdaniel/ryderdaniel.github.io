...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c0ad83b65aca733bce94f0d35ff2a02c965c43b493b2cb266fbe02975cd4eb3e.js',function(){input.required=false;search();});}
