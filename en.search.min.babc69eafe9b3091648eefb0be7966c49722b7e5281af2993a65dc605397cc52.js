...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.de6e89a8bdf595260c3ef1e56db9591e6239f62317a28f42d7643bc5ccfebf4a.js',function(){input.required=false;search();});}
