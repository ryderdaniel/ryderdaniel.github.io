...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6084c10e7d3d29f48a6764c11366f21ab77c8833e4679008063c10dee97703a8.js',function(){input.required=false;search();});}
